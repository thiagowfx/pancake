...
main() {
    ...
    check_and_run "pi" "PI Coding Agent" "npm install -g @mariozechner/pi-coding-agent || (command -v doas >/dev/null 2>&1 && doas npm install -g @mariozechner/pi-coding-agent) || (command -v sudo >/dev/null 2>&1 && sudo npm install -g @mariozechner/pi-coding-agent)"
